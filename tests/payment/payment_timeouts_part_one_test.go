...
func TestTimeoutsPartOne1aCheckNodeOnlyOnOnePathPaymentPass(t *testing.T) {
	...
	nodes[11].SetTestingFlag(t, vtcp.FlagSleepOnNextNeighborResponseProcessing, "", "")
	nodes[12].SetTestingFlag(t, vtcp.FlagSleepOnNextNeighborResponseProcessing, "", "")
...
func TestTimeoutsPartOne1cLostMessagesOnOtherPathWithoutPass(t *testing.T) {
	...
	nodes[11].SetTestingFlag(t, vtcp.FlagSleepOnNextNeighborResponseProcessing, "", "")
	nodes[12].SetTestingFlag(t, vtcp.FlagSleepOnNextNeighborResponseProcessing, "", "")
	nodes[0].SetTestingFlag(t, vtcp.FlagForbidSendResponseToIntemediateOnReservation, nodes[12].IPAddress, "")
